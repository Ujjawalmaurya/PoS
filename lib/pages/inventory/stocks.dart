    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            SearchField(
              hint: "Search (i.e., name, manufacturer, sub category, batch number)",
              onChanged: (keyword) => controller.searchItems(keyword),
            ),
            Flexible(
              child: Obx(
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return InventoryItemTile(
                            ...
                            ontap: () => controller.showItemData(context, _data),
                          );
                        },
                      ),
              ),
